...
{
    float ca = cos(freq * pos.y);
    float sa = sin(freq * pos.y);
    vec3 pos2 = vec3(pos.x * ca - pos.z * sa, pos.y, pos.x * sa + pos.z * ca);
    ...
    vec2 res = opU(vec2(sdPlane(pos), 1.0),
                   vec2(udRoundBox(pos3-vec3(0.0,1.0, 0.0), vec3(1.0), 0.05), 3.0));
    return res;
}
